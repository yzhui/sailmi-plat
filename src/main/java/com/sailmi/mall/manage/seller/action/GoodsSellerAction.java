...
import com.sailmi.mall.foundation.domain.WaterMark;
...
import com.sailmi.mall.foundation.domain.query.ReportQueryObject;
import com.sailmi.mall.foundation.domain.query.TransportQueryObject;
...
import com.sailmi.mall.foundation.service.IWaterMarkService;
	...
	public void swf_upload(HttpServletRequest request,
		...
		if (remainSpace > fileSize) {
			try {
				...
				System.out.println("lllllllllllllllllllllllllllll:source is:"+source);
	...
	public ModelAndView add_goods_finish(HttpServletRequest request,
		...
		if (goods_session1.equals("")) {
			...
			if (id.equals("")) {
				...
				goods = (Goods) wf.toPo(request, obj);//id为空的时候，会自动赋为0why?
