...
import com.sailmi.mall.foundation.domain.HomePageGoodsClass;
...
import com.sailmi.mall.foundation.domain.query.FavoriteQueryObject;
 ...
 public class BaseBuyerAction
 {
   ...
   public ModelAndView index(HttpServletRequest request, HttpServletResponse response, String currentPage, String orderBy, String orderType, String type)
   {
	 ...
	 if( (smmall_view_type != null) && (!smmall_view_type.equals( "" )) && (smmall_view_type.equals( "mobile" )) ) {
		 mv = new JModelAndView("mobile/buyer_index.html", this.configService.getSysConfig(), 
