 package com.sailmi.mall.pay.tools;
...
import com.sailmi.mall.pay.alipay.services.AlipayService;
import com.sailmi.mall.pay.alipay.util.AlipaySubmit;
import com.sailmi.mall.pay.alipay.util.UtilDate;
import com.sailmi.mall.pay.bill.config.BillConfig;
import com.sailmi.mall.pay.bill.services.BillService;
import com.sailmi.mall.pay.bill.util.BillCore;
import com.sailmi.mall.pay.bill.util.MD5Util;
import com.sailmi.mall.pay.chinabank.util.ChinaBankSubmit;
import com.sailmi.mall.pay.paypal.PaypalTools;
 ...
 public class PayTools
 {
   ...
   public String genericAlipaymobile(String url, String payment_id, String type, String id)
     throws Exception
   {
     String result = "";
     OrderForm of = null;
     ...
     sParaTempToken.put("service", "alipay.mobile.trade.create.direct");
     ...
     String sHtmlTextToken = AlipaySubmit.buildRequest(config, "mobile", sParaTempToken, "", "");
     ...
     Map sParaTemp = new HashMap();
     sParaTemp.put("service", "alipay.mobile.auth.authAndExecute");
     ...
     String mobile_ALIPAY_GATEWAY_NEW = "http://mobilepaygw.alipay.com/service/rest.htm?";
     result = AlipaySubmit.buildForm(config, sParaTemp, mobile_ALIPAY_GATEWAY_NEW, "get", "确认");
 
     return result;
   }
 
   public String generic99Billmobile(String url, String payment_id, String type, String id)
     throws UnsupportedEncodingException
   {
     String result = "";
     OrderForm of = null;
   ...
   public String genericChinaBankmobile(String url, String payment_id, String type, String id)
   {
     OrderForm of = null;
     Predeposit obj = null;
     GoldRecord gold = null;
   ...
   public String genericPaypalmobile(String url, String payment_id, String type, String id)
   {
     OrderForm of = null;
     Predeposit obj = null;
     GoldRecord gold = null;
