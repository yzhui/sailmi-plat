package com.sailmi.constant;


public class Globals
{
  public static final String DEFAULT_SYSTEM_TITLE = "Sailmi Mall V2.0";
  ...
  public static final String DEFAULT_WBESITE_NAME = "SailMi 服务平台";
  ...
  public static final String DEFAULT_TABLE_SUFFIX = "tbl_";
  public static final String THIRD_ACCOUNT_LOGIN = "tbl_thid_login_";
