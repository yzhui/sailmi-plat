...
import com.sailmi.sailplat.view.web.tools.ImageViewTools;
...
import org.springframework.web.servlet.ModelAndView;
 ...
 public class LoginViewAction
 {
   ...
   /**
	 * 用户登录跳转页面，默认情况下为普通的用户登录，如果是管理员，则重定向到admin/login.htm
	 * @param request
	 * @param response
	 * @param url
	 * @return
   ...
   public ModelAndView login(HttpServletRequest request, HttpServletResponse response, String url) {
     ...
     System.out.println("33333333333333333333333333333333"+this.configService.getSecurityAuthType().getLoginUrl());
     //处理登录url
