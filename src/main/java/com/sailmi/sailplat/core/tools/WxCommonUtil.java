...
public class WxCommonUtil {
    ...
    public static String httpsRequestString(String requestUrl, String requestMethod, String outputStr) {
        try {
            ...
            TrustManager[] tm = { new DefautX509TrustManager() };
    ...
    public static WxToken getToken(String appid, String appsecret) {
        ...
        if (null != jsonObject) {
            try {
                ...
                WxToken.setExpiresIn(jsonObject.getIntValue("expires_in"));
            } catch (JSONException e) {
                WxToken = null;
                // 获取WxToken失败
                log.error("获取WxToken失败 errcode:{} errmsg:{}", jsonObject.getIntValue("errcode"), jsonObject.getString("errmsg"));
            }
        }
        return WxToken;
    }
