...
import com.sailmi.sailplat.foundation.domain.query.AreaQueryObject;
...
public class AreaManageAction {
	...
	public ModelAndView area_import( HttpServletRequest request, HttpServletResponse response, String list_url ) throws Exception {
		...
		this.databaseTools.execute( "update tbl_store set area_id=null" );

		this.databaseTools.execute( "update tbl_address set area_id=null" );

		this.databaseTools.execute( "update tbl_area set parent_id=null" );

		this.databaseTools.execute( "delete from tbl_area" );
	...
	public ModelAndView area_export( HttpServletRequest request, HttpServletResponse response ) throws Exception {
		...
		String tables = "tbl_accessory,tbl_adv_pos,tbl_advert,tbl_articleclass,tbl_article,tbl_document,tbl_navigation,tbl_template,tbl_sysconfig";
