...
import com.sailmi.sailplat.pay.alipay.config.AlipayConfig;
 ...
 public class AlipayNotify
 {
   ...
   /**
	 ...
	 * @return 验证结果
	 */
	public static boolean verifymobile(AlipayConfig config, Map<String, String> params) {
		...
		boolean isSign = getSignVeryfymobile(config, params, sign);
   ...
   public static Map<String, String> decrypt(AlipayConfig config, Map<String, String> inputPara) throws Exception {
       ...
       AlipayConfig.getPrivate_key(), config.getInput_charset()));
	   return inputPara;
   }
 
   public static boolean verifyNotifymobile(AlipayConfig config, Map<String, String> params) throws Exception {
   ...
   private static boolean getSignVeryfy(AlipayConfig config, Map<String, String> Params, String sign, boolean isSort)
   {
	 ...
	 * @return 生成的签名结果
	 */
	private static boolean getSignVeryfymobile(AlipayConfig config, Map<String, String> Params, String sign) {
		...
		if (config.getSign_type().equals("RSA")) {
			isSign = RSA.verifymobile(preSignStr, sign, AlipayConfig.getAli_public_key(), config.getInput_charset());
		}
		return isSign;
	}
