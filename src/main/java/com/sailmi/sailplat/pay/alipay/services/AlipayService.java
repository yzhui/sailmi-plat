 package com.sailmi.sailplat.pay.alipay.services;
...
import com.sailmi.sailplat.pay.alipay.util.AlipaySubmit;
 ...
 public class AlipayService
 {
   ...
   {
	 System.out.println("Pay Use create_direct_pay_by_user");
   ...
   {
	 System.out.println("Pay Use create_partner_trade_by_buyer");
   ...
   {
	 System.out.println("Pay Use trade_create_by_buyer");
