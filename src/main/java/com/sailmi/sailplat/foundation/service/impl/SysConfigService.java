...
public class SysConfigService implements ISysConfigService {
	...
	public SecurityAuthType getSecurityAuthType() {
		return securityAuthType;
	}

	public void setSecurityAuthType(SecurityAuthType authType) {
		this.securityAuthType = authType;
	}
