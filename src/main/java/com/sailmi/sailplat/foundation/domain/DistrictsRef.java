...
public class DistrictsRef implements java.io.Serializable {
	...
	public DistrictsRef(long mdistrictId, long refDistrictId, String desc, Date createDate, Date modifyDate) {
